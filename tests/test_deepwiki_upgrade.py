...
class BlueprintPromptTests(unittest.TestCase):
    def test_default_blueprint_preserves_deepwiki_memory(self):
        ...
        self.assertEqual(blueprint["repo_name"], "mogcoin")
        self.assertEqual(blueprint["scope_files"], ["src/MOG.sol"])
    ...
    def test_question_generator_includes_blueprint_and_local_proof_language(self):
        ...
        self.assertIn("src/MOG.sol", prompt)
...
[
  ...
  "https://deepwiki.com/example/mogcoin--001",
  "https://deepwiki.com/example/mogcoin--002"
]
"""
